...
function NavBar({activeNav,setActiveNav,scrolled}) {
  return (
    <nav style={{
      ...
      <button className="join-btn" style={{background:"#D4AF37",color:"#060A10",border:"none",borderRadius:"8px",padding:"8px 18px",fontWeight:700,fontSize:"0.78rem",cursor:"pointer",transition:"all 0.2s",fontFamily:"'DM Sans',sans-serif"}}>Join the Fan World</button>
    </nav>
  );
}
...
export default function Golazo() {
  ...
  return (
    <div id="gz-root" style={{fontFamily:"'DM Sans', sans-serif",background:"#060A10",color:"#EEE9DF",minHeight:"100vh",overflowY:"auto",overflowX:"hidden"}}>
      ...
      `}</style>
      <NavBar activeNav={activeNav} setActiveNav={setActiveNav} scrolled={scrolled}/>
      {renderPage()}
      <Footer/>
    </div>
  );
